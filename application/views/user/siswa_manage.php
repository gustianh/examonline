    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="d-flex align-items-center">
                ...
                <a class="btn btn-danger text-white" data-toggle="modal" data-target="#deleteModal"><i class="fas fa-trash"></i>  Hapus Angkatan</a>
            </div>
        </div>
        <div class="card-body">
...
<!-- Print Modal -->
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="cetakModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="cetakModalLabel">Hapus Angkatan</h5>
